...
(function (global) {
  ...
  const STATUS = {
    ...
    "en-analyse": ["Analyse", "info"],
    echange: ["Échange", "warn"],
    "profil-defini": ["Profil défini", "ok"],
    "offre-preparation": ["Offre en préparation", "warn"],
    "validation-client": ["Validation client", "orange"],
    recherche: ["Recherche", "info"],
    preselection: ["Présélection", "info"],
    shortlist: ["Shortlist", "ok"],
    "revue-client": ["Revue client", "orange"],
    decision: ["Décision", "warn"],
    termine: ["Terminé", "muted"],
    REQUEST_SUBMITTED: ["Besoin transmis", "info"],
    UNDER_REVIEW: ["Analyse", "info"],
    CLIENT_CONTACTED: ["Échange", "warn"],
    NEEDS_CONFIRMED: ["Profil défini", "ok"],
    JOB_BEING_PREPARED: ["Offre en préparation", "warn"],
    CLIENT_VALIDATION: ["Validation client", "orange"],
    JOB_PUBLISHED: ["Recherche lancée", "ok"],
    SOURCING: ["Recherche", "info"],
    SCREENING: ["Présélection", "info"],
    INTERVIEWS: ["Entretiens", "info"],
    SHORTLIST: ["Shortlist", "ok"],
    CLIENT_REVIEW: ["Revue client", "orange"],
    HIRING: ["Décision", "warn"],
    CLOSED: ["Terminé", "muted"],
