            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="hero2-heading tl-hero-lock">
                        ...
                        <h1 class="tl-hero-note">Les talents qui font tourner l'industrie. Sans frais pour le candidat — dossier présenté aux bons employeurs.</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="hero2-heading tl-hero-lock">
                        ...
                        <p class="tl-hero-note">Les talents qui font tourner l'industrie. Sans frais pour le candidat — dossier présenté aux bons employeurs.</p>
                    </div>
                </div>
            </div>
        </div>
