...
COPY = {
    "fr": {
        ...
        "keywords": "agence de recrutement, agence de placement, recrutement de talents, recrutement professionnel, recrutement intelligent, agence de recrutement en ligne, solution de recrutement, placement de personnel, recherche de candidats, recherche d'emploi, offres d'emploi, Talendus Québec",
    },
    "en": {
        "html_lang": "en-CA",
        "og_locale": "en_CA",
        ...
        "keywords": "recruitment agency, staffing agency, talent recruiting, professional recruiting, intelligent recruiting, online recruitment agency, hiring solution, personnel placement, candidate search, job search, job openings, Talendus Quebec",
    },
}
...
FAQ_HOME = [
    ...
    ("Comment l'intelligence artificielle intervient-elle ?",
     "L'IA aide Talendus à traiter et analyser les informations plus rapidement, au cœur de notre propre processus. Elle n'est pas un outil remis aux entreprises pour chercher des candidats elles-mêmes. Plusieurs capacités (analyse de CV, rapprochement, priorisation interne) sont encore en cours d'intégration : elles ne sont pas toutes opérationnelles, et rien n'est simulé. Un conseiller reste indispensable pour qualifier et présenter."),
    ("Est-ce que l'IA choisit les candidats ?",
     "Non. L'IA n'embauche pas et ne prend pas la décision finale. Elle peut aider nos équipes à identifier, analyser et prioriser. Les conseillers vérifient la pertinence, échangent avec les personnes et constituent la shortlist. L'entreprise choisit."),
...
FAQ_EMPLOYEURS = [
    ...
    ("Comment confier un recrutement à Talendus ?",
     "Décrivez votre besoin via le formulaire, un appel ou votre espace entreprise. Indiquez le poste, les compétences, l'expérience, le lieu, le type de contrat et l'urgence. Un conseiller reprend le brief. Publier une offre visible n'est pas obligatoire : beaucoup de mandats restent confidentiels."),
    ...
    ("Talendus recherche-t-il directement les candidats ?",
     "Oui. C'est précisément le modèle. Vous ne cherchez pas vous-même dans une base. Nous mobilisons le réseau, les profils déjà connus, les candidatures reçues et nos outils — y compris, progressivement, l'IA — pour identifier les personnes pertinentes."),
    ...
    ("Qui présélectionne les candidats ?",
     "L'équipe Talendus. Les conseillers analysent les parcours, comparent les compétences aux critères du poste, et écartent ce qui ne tient pas. L'IA, lorsqu'elle est intégrée à une étape, aide à traiter l'information plus vite ; elle ne remplace pas cette présélection humaine."),
    ...
    ("Comment l'IA intervient-elle ?",
     "Elle soutient le processus interne de Talendus : aider à analyser des parcours, repérer des compétences, rapprocher un profil d'un besoin, prioriser des dossiers pour nos équipes. Elle n'est pas un assistant que vous utilisez pour chercher vous-même. Plusieurs de ces capacités sont encore en cours d'intégration ; rien n'est simulé."),
    ("Est-ce que l'IA choisit les candidats ?",
     "Non. Aucune décision d'embauche n'est automatique. L'IA n'écarte pas à votre place et n'impose pas un « candidat parfait ». Les conseillers qualifient. Vous décidez."),
...
FAQ_HOME_EN = [
    ...
    ("How does artificial intelligence come in?",
     "AI helps Talendus process and analyse information faster, inside our own process. It is not a tool we hand to companies so they can hunt candidates themselves. Several capabilities (resume analysis, matching support, internal prioritization) are still being integrated: they are not all live, and nothing is simulated. A consultant remains essential to qualify and present."),
    ("Does AI choose the candidates?",
     "No. AI does not hire and does not make the final decision. It can help our teams identify, analyse and prioritize. Consultants verify fit, speak with people and build the shortlist. The company chooses."),
...
FAQ_EMPLOYERS_EN = [
    ...
    ("Does Talendus search for candidates directly?",
     "Yes. That is the model. You do not search a database yourself. We use the network, known profiles, applications received and our tools — including, progressively, AI — to identify relevant people."),
    ...
    ("Who screens the candidates?",
     "The Talendus team. Consultants review careers, compare skills to the role, and drop what does not hold. When AI is integrated into a step, it helps process information faster; it does not replace that human screen."),
    ...
    ("How does AI come in?",
     "It supports Talendus's internal process: helping analyse careers, spot skills, relate a profile to a need, prioritize files for our teams. It is not an assistant you use to search on your own. Several of these capabilities are still being integrated; nothing is simulated."),
    ("Does AI choose the candidates?",
     "No. No hiring decision is automatic. AI does not reject in your place and does not impose a « perfect candidate ». Consultants qualify. You decide."),
